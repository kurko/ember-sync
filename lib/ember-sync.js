...
export default Ember.Object.extend(
  ...
  createRecord: function(type, properties) {
    ...
    if (properties) {
      record = offlineStore.createRecord(type, properties);
    } else {
      record = offlineStore.createRecord(type);
    }
    ...
    record.emberSync = Ember.Object.create({
      ...
      save: function() {
        var persistence = Persistence.create({
          onlineSerializer: this.get('emberSync.onlineSerializer'),
          onlineAdapter:    this.get('emberSync.onlineAdapter'),
